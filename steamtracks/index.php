...
try {
    ...
    if (empty($steamID->getSteamID32())) {
        ...
        if (isset($_GET['refresh'])) {
            ...
            $file_name_location = '../sig/images/generated/' . $steamID->getsteamID32() . '_main.png';
        ...
        echo '<div class="row">
                <div class="text-center">
                    ...
                    <p><a class="nav-clickable btn btn-danger btn-lg" href="#steamtracks/?refresh">Refresh Signature</a></p>
                </div>
            </div>';
