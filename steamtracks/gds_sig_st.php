...
try{
/*
echo 'INSERT INTO `mmr` (`steam_id`, `steam_name`, `private_profile`, `dota_level`, `dota_wins`, `rank_solo`, `rank_solo_calib`, `rank_team`, `rank_team_calib`, `commends_forgiving`, `commends_friendly`, `commends_leadership`, `commends_teaching`, `last_updated`) 
					VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) 
					ON DUPLICATE KEY UPDATE `steam_id` = VALUES(`steam_id`), `steam_name` = VALUES(`steam_name`), `private_profile` = VALUES(`private_profile`), `dota_level` = VALUES(`dota_level`), `dota_wins` = VALUES(`dota_wins`), `rank_solo` = VALUES(`rank_solo`), `rank_solo_calib` = VALUES(`rank_solo_calib`), `rank_team` = VALUES(`rank_team`), `rank_team_calib` = VALUES(`rank_team_calib`), `commends_forgiving` = VALUES(`commends_forgiving`), `commends_friendly` = VALUES(`commends_friendly`), `commends_leadership` = VALUES(`commends_leadership`), `commends_teaching` = VALUES(`commends_teaching`), `last_updated` = VALUES(`last_updated`);<br />';
*/
...
$wins  = ' <strong>[No Wins]</strong> ';
			...
			$players_total[] = $player_id.', '.$playerName.'<br />';
		}
		...
		echo '<br /><strong>Total Players</strong>: '.count($players).'<br />';
		echo '<pre>';
