      ...
      <div class="container">
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="/dbe">Dotabuff Extended</a></li>
    ...
    <div class="container">
		<div class="row">
			<div class="col-sm-8 blog-main">
				<div class="blog-post">
					<p>Comments and site feedback can be left in the ChatBox or in the IRC channel <a href="irc://irc.gamesurge.net:6667/getdotastats">#GetDotaStats</a> on GameSurge.</p>
					<p>Issues and feature requests can be left in our <a href="https://github.com/jimmydorry/getdotastats/issues" target="__new">GitHub issue tracker</a>.</p>
