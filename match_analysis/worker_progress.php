...
try {
    ...
    if ($db) {
        ...
        echo '<span class="h5">Tasks:</span> ' . $tasks_completed_format . ' / ' . $tasks_total_format . ' (' . $tasks_completed_per_format . ')<br />';

        $time_taken = (strtotime($d2_worker_task_count[0]['latest_date']) - strtotime($d2_worker_task_count[0]['earliest_date'])) / 60 / 60 / 24;
        echo '<span class="h5">Total Uptime:</span> ' . number_format($time_taken, 2) . 'days<br />';
        ...
        echo '<span class="h5">Estimated Time Left:</span> ' . number_format($estimated_time - $time_taken, 2) . 'days (Total of ' . number_format($estimated_time, 2) . 'days.)<br />';
        ...
        echo '<span class="h5">Time Required for last 20tasks:</span> ' . number_format($time_taken_l10, 2) . 'days<br />';
        echo '<span class="h5">Estimated Time Left (last 20 tasks):</span> ' . number_format($estimated_time_l10 - $time_taken_l10, 2) . 'days<br />';
