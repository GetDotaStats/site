...
try {
    ...
    foreach ($currentMG as $key => $value) {
        ...
        $mgFactor = !empty($value['minigameFactor']) && is_numeric($value['minigameFactor'])
            ? '<input type="number" name="minigameFactor" maxlength="20" size="4" value="' . floatval($value['minigameFactor']) . '" min="0" max="1000">'
            : '<input type="number" name="minigameFactor" maxlength="20" size="4" value="1" min="0" max="1000">';

        $mgDecimals = !empty($value['minigameDecimals']) && is_numeric($value['minigameDecimals'])
            ? '<input type="number" name="minigameDecimals" maxlength="20" size="4" value="' . $value['minigameDecimals'] . '" min="0" max="10">'
            : '<input type="number" name="minigameDecimals" maxlength="20" size="4" value="2" min="0" max="10">';
