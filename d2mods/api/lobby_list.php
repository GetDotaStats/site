        ...
        if (!empty($lobbyListSQL)) {
            foreach ($lobbyListSQL as $key => $value) {
                ...
                $lobbyName = !empty($value['lobby_name'])
                    ? htmlentitiesdecode_custom($value['lobby_name'])
                ...
                $lobbyLeaderName = !empty($value['lobby_leader_name'])
                    ? htmlentitiesdecode_custom($value['lobby_leader_name'])
                    : 'Unknown??';

                $lobbyMap = !empty($value['lobby_map'])
                    ? htmlentitiesdecode_custom($value['lobby_map'])
                    : NULL;

                $lobbyOptions = !empty($value['lobby_options'])
                    ? htmlentitiesdecode_custom($value['lobby_options'])
                    : NULL;
                ...
                $lobbyList[] = array(
                    ...
                    'lobby_pass' => htmlentitiesdecode_custom($value['lobby_pass']),
                    'lobby_map' => $lobbyMap,
