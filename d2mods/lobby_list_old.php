...
try {
    ...
    echo '<div class="alert alert-danger" role="alert"><strong>RIP LobbyExplorer</strong><br />The release of the Dota2 Reborn client has marked the end of LobbyExplorer. Don\'t worry though! We are taking a short break to update our libraries. You will see us in the modding community again shortly. Join our Steam group to ensure you always get the latest news!</div>';
    ...
    if (!empty($lobbyListActive)) {
        ...
        foreach ($lobbyListActive as $key => $value) {
            ...
            echo '<tr>
                        ...
                        <td class="vert-align"><a class="nav-clickable" href="#s2__mod?id=' . $value['mod_id'] . '">' . $value['mod_name'] . '</a> ' . $workshopLink . '</td>
