...
<p><strong>3.</strong> Once there, scroll down and find the 'Dota 2 Workshop Tools Alpha' and Install it.</p>
...
<p>Now that you have installed the Dota 2 Workshop Tools, installed the Lobby Explorer and logged into the site; it is
    time for you to make use of our system! <strong>The in-game lobby list must be refreshed manually, by clicking the
        refresh symbol in the top right corner.</strong> It has a rate-limit of 5seconds.</p>
<p><strong>1.</strong> Start your Dota 2 client.</p>
<p><strong>2.</strong> Navigate to the PLAY tab and click on CUSTOM LOBBY BROWSER, in order to find lobbies.
    <a target="_blank" href="http://gfycat.com/GrippingGenuineIndochinesetiger">VIDEO EXAMPLE</a></p>
