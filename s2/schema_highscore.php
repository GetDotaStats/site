...
<p>If your mod is round based with progress completely wiped between rounds, then simply start this process at the end
    of each round.</p>
...
<ul>
    <li>We can lock this down by having an authKey that is communicated to the client on each new save. Before
        ...
        code into chat "-code XXXXX", as people did in WC3.
    </li>
</ul>
            ...
            <div class="panel-body">
                ...
                <div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">"SAVE"</div>
                    </div>

                    <div class="row">
                        <div class="col-sm-3">modID</div>
                        <div class="col-sm-2">string</div>
                        <div class="col-sm-7">"7689asdfjh1231"</div>
                    </div>

                    <div class="row">
                        <div class="col-sm-3">highscoreID</div>
                        <div class="col-sm-2">string</div>
                        <div class="col-sm-7">"hj43152khjb342"</div>
                    </div>
